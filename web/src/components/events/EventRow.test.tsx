...
it("shows UTC time then title then details while preserving machine-readable ISO", () => {
  render(<EventRow event={{ id: 1, event_type: "PORTAL_OPENED", created_at: "2026-09-06T15:04:05Z", message: "A way opens", payload_json: null, portal_id: 1, observer_id: null, plane_id: 1 }} />);
  ...
  expect(title.compareDocumentPosition(screen.getByText("A way opens")) & Node.DOCUMENT_POSITION_FOLLOWING).toBeTruthy();
});
