...
const chapters = [
  ...
  [
    "Tutorial recap",
    "Step 0: Read the laboratory introduction, then begin practice. Step 1: Select the highlighted Portal on the Dashboard to inspect it. Step 2: Wait for creatures to clear the corridor. Step 3: SEND OBSERVER; the Observer becomes OUTBOUND. Step 4: STABILIZE the prepared UNSTABLE Portal, reducing HIGH/CRITICAL Risk to MEDIUM/LOW. Step 5: Attempt SEND through the prepared CRITICAL Portal; its expected rejection completes this step. Step 6: Wait for research, then RECALL through a new Portal to the same Plane; the Observer becomes RETURNING. Step 7: Wait for successful return; the Observer becomes AVAILABLE and the Plane becomes EXPLORED. Step 8: Open the Event Log. Step 9: Training is complete; start Live exploration. Training advances when its expected action or event occurs. Tutorial reset starts the training laboratory over; it is not a way to preserve Live progress.",
  ],
  [
    "Glossary",
